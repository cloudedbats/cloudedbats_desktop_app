...
#         self.name_combo.addItems([])
        self.name_edit = QtWidgets.QLineEdit('event_1')
...
#         dataframe = pandas.DataFrame(event_list, hdf5_path_list, columns=['event', 'hdf5_path'])
        dataframe = pandas.DataFrame({'event': event_list, 'hdf5_path': hdf5_path_list})
        model = app_framework.PandasModel(dataframe[['event', 'hdf5_path']])
