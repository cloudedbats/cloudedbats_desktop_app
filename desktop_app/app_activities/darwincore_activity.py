...
class DarwinCoreActivity(app_framework.ActivityBase):
    """ """
    ...
    def __init__(self, name, parentwidget):
        ...
        super(DarwinCoreActivity, self).__init__(name, parentwidget)
    ...
    def _create_content(self):
        ...
        tabWidget.addTab(self._content_darwincore(), 'DarwinCore')
